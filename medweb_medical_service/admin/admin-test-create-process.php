...
$test->id = uniqid();
$test->title = Utility::sanitize($_POST['name']);      
...
<div class="card">
							...
							<i class="icon-check2 icon-2x text-success-400 border-success-400 border-3 rounded-round p-3 mb-3 mt-1"></i>
								...
								<p class="mb-3">Test has been added Successfully.</p>
								<a href="medical-test-admin.php" class="btn bg-success-400">GO TO All Test</a>
							</div>
						</div>
