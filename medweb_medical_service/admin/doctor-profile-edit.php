        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="doctor-profile-edit-process.php" method="post" enctype="multipart/form-data">
                            <fieldset>

                                <input name="id" type="hidden" class="form-control" value="<?=$doc->id?>" required>
                                <div class="form-group">
                                    <label>Doctor Type:</label>
                                    <input name="type" type="text" class="form-control" placeholder="Doctor Type"
                                        value="<?=$doc->specialist?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="exp" type="text" class="form-control"
                                        ...
                                        value="<?=$doc->Experiences_Summary?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="email" type="email" class="form-control" placeholder="Email"
                                        value="<?=$doc->email?>" required>
                                </div>

                                <div class="form-group">
                                    <label>Practice Days:</label>
                                    <input name="day" type="text" class="form-control"
                                        placeholder="EX : Monday, Wednesday, Saturday 3:00PM to 8:00PM"
                                        value="<?=$doc->Practice_Days?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?=$images2.'doctor-images/'.$doc->image?>"
                                        style="width:100px;height:100px">
                                    <input name="old_picture" type="text" class="form-control" value="<?=$doc->image?>">
