...
$slider = new Slider();
$slider->name = Utility::sanitize($_POST['title']);      
$slider->heading = Utility::sanitize($_POST['head']) ;
$slider->paragraph = Utility::sanitize($_POST['para']);
$slider->src = $src;
		...
		<div class="content-wrapper">
            ...
            <div class="card">
                                    ...
                                    <i class="icon-check2 icon-2x text-success-400 border-success-400 border-3 rounded-round p-3 mb-3 mt-1"></i>
                                        ...
                                        <p class="mb-3">Slider has been saved Successfully.</p>
                                        <a href="slider-list.php" class="btn bg-success-400">GO TO LIST</a>
                                    </div>
                                </div>
