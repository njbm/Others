...
$appoint_list = new Appointment();
$list = $appoint_list->list();
					...
					<table class="table datatable-basic">
						<thead>
							<tr>
								...
								<th>Address</th>
								<th>Phone</th>
								<th>Appointemnt Time and Date</th>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<form action="appointment-delete.php" method="post">
												<input type="hidden" name="id" value="<?=$appoint->id?>">
