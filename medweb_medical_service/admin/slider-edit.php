						...
						<form action="slider-edit-process.php" method="post" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="form-group">
									...
									<input name="head" type="text" class="form-control" placeholder="Heading"
                                    value="<?=$slide->heading?>" required>
								</div>

								<div class="form-group">
									<label>Slider Paragraph:</label>
									<input name="para" type="text" class="form-control" placeholder="paragraph" value="<?=$slide->paragraph?>" required>
								</div>

								<div class="form-group">
									<label>Alternative Name:</label>
									<input name="alt" type="text" class="form-control" placeholder="Alt Name"
                                    value="<?=$slide->alt?>" required>
								</div>
								...
								<img src="<?=$images2.$slide->src?>" style="width:100px;height:100px">
