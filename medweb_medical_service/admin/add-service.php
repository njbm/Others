		...
		<div class="content-wrapper">
            ...
            <div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Add New Service Card</h5>
					...
					<div class="card-body">
						...
						<form action="add-service-process.php" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<input name="icon" type="text" class="form-control" placeholder="Icon (***Use Font Awesome Icon)" required>
								</div>
