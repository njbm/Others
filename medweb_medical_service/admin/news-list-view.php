				...
				<?php
					...
					<table class="table datatable-basic">
                        ...
                        <?php
                         ...
                         foreach($newsAll as $key=>$news_info){ ?>
							<tr>
								...
								<td><?=$news_info->alt?></td>
                                <td><img src="<?=$images2.'news-images/'.$news_info->src?>" style="width: 100px; height: 80px;"></td>
								...
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											...
											<form action="news-view.php" method="post">
												...
												<input type="hidden" name="id" value="<?=$news_info->id?>">
												<input type="hidden" name="picture" value="<?=$news_info->src?>">
