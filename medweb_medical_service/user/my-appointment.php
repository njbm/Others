...
<div class="page-content">
	...
	<div class="content-wrapper">
        ...
        <h5 class="mb-3">My Appointemnt</h5>

        <div class="card card-body">
							<div class="media">
								<div class="media-body">
									<h6 class="media-title text-indigo font-weight-semibold">You have an appointment!</h6>
									<p class="text-dark">You have an appointment with <a href="#">doctor name</a></p>
                                    <p>Appoinment Date: date</p>
								</div>
